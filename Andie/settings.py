"""
Django settings for Andie project.
...
from Andie.jazzmin_settings import JAZZMIN_SETTINGS, JAZZMIN_UI_TWEAKS
...
ALLOWED_HOSTS = os.environ.get("DJANGO_ALLOWED_HOSTS", "your-app-name.azurewebsites.net").split(",")
...
WSGI_APPLICATION = 'Andie.wsgi.application'
